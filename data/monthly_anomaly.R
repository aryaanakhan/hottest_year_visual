...
month_anom<- read_table(file = "C:/Users/aryaa/Desktop/my_working_directory/merra2_seas_anom.txt", skip = 3) %>%
  select(month = Month, seas_anom) %>%
  mutate(month = as.numeric(month), 
         month = month.abb[month])

t_data <- read_csv("C:/Users/aryaa/Desktop/my_working_directory/GLB.Ts+dSST.csv", skip = 1, na = "*******") %>%
...
ggsave("C:/Users/aryaa/Desktop/my_working_directory/monthly_anomaly.png", width=6, height=4, units="in")
